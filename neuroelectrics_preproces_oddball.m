...
chan_names = struct('labels', { 'PO7' 'CP1' 'P3' 'Cz' 'Pz' 'CP2'  'P4'  'PO8'});
...
% two different conditions over parietal electrodes. Are the conditions
% different between 300-600 ms?
%-----------------------------------------------------------------------

fig = plot_erp_oddball_avg_parietal({EEGcon, EEGincon},{'PO7', 'CP1', 'P3', 'Cz', 'Pz', 'CP2',  'P4',  'PO8'}) 
